...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\wamp\\www\\Symfony\\src\\ALTests\\AJAXBundle\\Entity', 1 => 'C:\\wamp\\www\\Symfony\\src\\ALTests\\PHPBundle\\Entity'));
        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'ALTests\\AJAXBundle\\Entity');
        $f->addDriver($e, 'ALTests\\PHPBundle\\Entity');
        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('ALTestsAJAXBundle' => 'ALTests\\AJAXBundle\\Entity', 'ALTestsPHPBundle' => 'ALTests\\PHPBundle\\Entity'));
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '4e91163cd1247e5a321079554ba64524b');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\ALTests\\AJAXBundle/Resources/views', 'ALTestsAJAX');
        $instance->addPath('C:\\wamp\\www\\Symfony\\src\\ALTests\\PHPBundle/Resources/views', 'ALTestsPHP');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4e91163cd1247e5a321079554ba64524b');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ALTestsAJAXBundle' => 'ALTests\\AJAXBundle\\ALTestsAJAXBundle',
                'ALTestsPHPBundle' => 'ALTests\\PHPBundle\\ALTestsPHPBundle',
            ),
            ...
            'locale' => 'en',
            'secret' => '4e91163cd1247e5a321079554ba64524b',
            'database_path' => NULL,
            ...
            'kernel.secret' => '4e91163cd1247e5a321079554ba64524b',
